...
def ParseArgs():
	...
	parser.add_argument('--flow_prior', type=str, default='popularity', choices=['popularity', 'gaussian'])
	parser.add_argument('--cf_prior_mix', type=float, default=0.5)
	parser.add_argument('--cf_prior_dropout', type=float, default=0.5)
